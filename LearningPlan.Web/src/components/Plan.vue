        ...
        <div>
            <div v-if="isNameEdit" class="card-body d-flex flex-row">
                <div class="input-group mb-3 p-2">
                    <input id="plan-name" type="text" name="plan-name" class="form-control" v-model="plan.name"
                        placeholder="Plan name">
                    <button class="input-group-append btn btn-primary btn-outline-secondary" v-on:click="updateName"
                ...
                <div class="p-2">
                    <div class="btn-toolbar" role="toolbar">
                        <div class="btn-group mr-2" role="group">
                            <button v-if="isCurrentUserOwner" class="btn" type="button" title="Update name"
                                v-on:click="showNameUpdate">
                            ...
                            <button v-if="isCurrentUserOwner" class="btn" type="button" title="Delete plan"
                                v-on:click="deletePlan">
                            ...
                            <button v-if="plan.isTemplate" class="btn" type="button" title="Add template to my plans"
                                v-on:click="copyPlan">
                            ...
                            <a class="btn" title="Subscribe in Telegram" v-if="!plan.isTemplate" target="_blank"
                                :href="'https://t.me/learningplanbot?start=' + plan.id">
                                <svg width="2em" height="2em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            ...
            <div v-if="isCurrentUserOwner">
                <a data-toggle="modal" data-target="#addAreaModel">
                    <div class="card-body d-flex justify-content-center new-area">
                        <svg width="4em" height="4em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor"
